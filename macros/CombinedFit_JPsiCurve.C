...
void MultiFit_JPsiCurve() {
   ...
   TFile * f = new TFile("ALLEvents_histograms_MuonKTE_semilep_HLT_Mu8.root");

   // Histograms
   TH1F * DiMuonMass_matched = (TH1F*) f -> Get("DiMuonMass of matched muons");
   TH1F * DiMuonMass_failedmatched = (TH1F*) f -> Get("NOTMatchedDiMuonMass");
