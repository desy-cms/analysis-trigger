...
// USE THIS MACRO TO PLOT THE JET KINEMATIC TRIGGER EFFICIENCY FOR ETA VALUES FROM 1.0 TO 1.4, CORRESPONDING TO THE OVERLAP REGION
   ...
   TH1F * h_denominatorDATA = (TH1F*) fDATA -> Get("Probes 1<n<1.4/pt_jet2");
   // get numerator histograms
   TH1F * h_numeratorDATA  = (TH1F*) fDATA -> Get("Probes with matching 1<n<1.4/pt_jet2");
   ...
   TH1F * h_numerator1  = (TH1F*) f1 -> Get("Probes with matching 1<n<1.4/pt_jet2");
   TH1F * h_denominator1 = (TH1F*) f1 -> Get("Probes 1<n<1.4/pt_jet2");
   //get parameters
   ...
   // get denominator and denominator histograms for total
   TH1F * h_numerator2  = (TH1F*) f2 -> Get("Probes with matching 1<n<1.4/pt_jet2");
   TH1F * h_denominator2 = (TH1F*) f2 -> Get("Probes 1<n<1.4/pt_jet2");
   //get parameters
   ...
   // get denominator and denominator histograms for total
   TH1F * h_numerator3  = (TH1F*) f3 -> Get("Probes with matching 1<n<1.4/pt_jet2");
   TH1F * h_denominator3 = (TH1F*) f3 -> Get("Probes 1<n<1.4/pt_jet2");
   //get parameters
   ...
   // get denominator and denominator histograms for total
   TH1F * h_numerator4  = (TH1F*) f4 -> Get("Probes with matching 1<n<1.4/pt_jet2");
   TH1F * h_denominator4 = (TH1F*) f4 -> Get("Probes 1<n<1.4/pt_jet2");   
   //get parameters
   ...
   // get denominator and denominator histograms for total
   TH1F * h_numerator5  = (TH1F*) f5 -> Get("Probes with matching 1<n<1.4/pt_jet2");
   TH1F * h_denominator5 = (TH1F*) f5 -> Get("Probes 1<n<1.4/pt_jet2");
   // get denominator histograms
   //get parameters
   ...
   // get denominator and denominator histograms for total
   TH1F * h_numerator6  = (TH1F*) f6 -> Get("Probes with matching 1<n<1.4/pt_jet2");
   TH1F * h_denominator6 = (TH1F*) f6 -> Get("Probes 1<n<1.4/pt_jet2");
   //get parameters
   ...
   // get denominator and denominator histograms for total
   TH1F * h_numerator7  = (TH1F*) f7 -> Get("Probes with matching 1<n<1.4/pt_jet2");
   TH1F * h_denominator7 = (TH1F*) f7 -> Get("Probes 1<n<1.4/pt_jet2");
   //get parameters
   ...
   // get denominator and denominator histograms for total
   TH1F * h_numerator8  = (TH1F*) f8 -> Get("Probes with matching 1<n<1.4/pt_jet2");
   TH1F * h_denominator8 = (TH1F*) f8 -> Get("Probes 1<n<1.4/pt_jet2");
   //get parameters
   ...
   mg->SetTitle("Jet Kinematic Trigger Efficiency 1.0<|#eta|<1.4");
   mg->Add(g_effDATA);
   mg->Add(g_effMC);
